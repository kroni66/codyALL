...
//		ResetCapture();
	...
	{
		//if (m_pLeftCaptureWindow) {
		//	if (m_pLeftCaptureWindow->OnRunMouseWheelEvent(nLen)) {
		//		return true;
		//	}
		//
		//	if (m_pLeftCaptureWindow->GetRoot() && m_pLeftCaptureWindow->GetRoot()->RunMouseWheelEvent(nLen)) {
		//		return true;
		//	}
		//}
		//
		//CWindow * pWin = GetPointWindow();
		//if (pWin) {
		//	if (pWin->OnRunMouseWheelEvent(nLen)) {
		//		return true;
		//	}
		//
		//	if (pWin->GetRoot() && pWin->GetRoot()->RunMouseWheelEvent(nLen)) {
		//		return true;
		//	}
		//}
		...
		//if (m_pLockWindow)
		//{
		//	if (m_pLockWindow->OnRunMouseWheelEvent(nLen))
		//		return true;
		//}
		//
		//if (m_pActiveWindow)
		//{
		//	if (m_pActiveWindow->OnRunMouseWheelEvent(nLen))
		//		return true;
		//}
		//
		//return m_pRootWindow->RunMouseWheelEvent(nLen);
