...
class CommentSlot(ui.Window):
	...
	def __init__(self):
		...
		self.slotImage.LoadImage("d:/ymir work/ui/public/Parameter_Slot_06.sub")
		self.slotImage.SetPosition(0, 0)
		self.slotImage.SetScale(1.37, 1)
		self.slotImage.Show()
		...
		self.SetSize(self.slotImage.GetWidth() - 0, self.slotImage.GetHeight())
		self.len = 0
...
class GuildWindow(ui.ScriptWindow):
	...
	def __LoadWindow(self):
		...
		try:
			...
			self.pageWindow["BOARD"].GetChild("IndexID").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 0)
			self.pageWindow["BOARD"].GetChild("IndexID").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 0)
			self.pageWindow["BOARD"].GetChild("IndexMessages").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 1)
			self.pageWindow["BOARD"].GetChild("IndexMessages").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 1)
			self.pageWindow["GRADE"].GetChild("GradeNumber").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 2)
			self.pageWindow["GRADE"].GetChild("GradeNumber").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 2)
			self.pageWindow["GRADE"].GetChild("GradeName").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 3)
			self.pageWindow["GRADE"].GetChild("GradeName").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 3)
			self.pageWindow["GRADE"].GetChild("InviteAuthority").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 4)
			self.pageWindow["GRADE"].GetChild("InviteAuthority").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 4)
			self.pageWindow["GRADE"].GetChild("NoticeAuthority").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 5)
			self.pageWindow["GRADE"].GetChild("NoticeAuthority").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 5)
			self.pageWindow["GRADE"].GetChild("SkillAuthority").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 6)
			self.pageWindow["GRADE"].GetChild("SkillAuthority").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 6)
			self.pageWindow["GRADE"].GetChild("GuildWar").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 7)
			self.pageWindow["GRADE"].GetChild("GuildWar").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 7)
			self.pageWindow["MEMBER"].GetChild("IndexName").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 8)
			self.pageWindow["MEMBER"].GetChild("IndexName").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 8)
			self.pageWindow["MEMBER"].GetChild("IndexGrade").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 9)
			self.pageWindow["MEMBER"].GetChild("IndexGrade").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 9)
			self.pageWindow["MEMBER"].GetChild("IndexJob").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 10)
			self.pageWindow["MEMBER"].GetChild("IndexJob").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 10)
			self.pageWindow["MEMBER"].GetChild("IndexLevel").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 11)
			self.pageWindow["MEMBER"].GetChild("IndexLevel").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 11)
			self.pageWindow["MEMBER"].GetChild("IndexOffer").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 12)
			self.pageWindow["MEMBER"].GetChild("IndexOffer").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 12)
			self.pageWindow["MEMBER"].GetChild("IndexGeneral").SetStringEventIntro(ui.__mem_func__(self.OverOutToolTip), "MOUSE_OVER_OUT", "MOUSE_OVER_OUT", 13)
			self.pageWindow["MEMBER"].GetChild("IndexGeneral").SetStringEventIntro(ui.__mem_func__(self.OverInToolTip), "MOUSE_OVER_IN", "MOUSE_OVER_IN", 13)
		except:
			import exception
		...
		if not app.ADVANCED_GUILD_INFO:
	...
	def OverInToolTip(self, arg2, arg):
		text = [uiscriptlocale.GUILD_BOARD_ID, uiscriptlocale.GUILD_BOARD_TEXT, uiscriptlocale.GUILD_GRADE_NUM, uiscriptlocale.GUILD_GRADE_RANK, uiscriptlocale.GUILD_GRADE_PERMISSION_JOIN, uiscriptlocale.GUILD_GRADE_PERMISSION_NOTICE, uiscriptlocale.GUILD_GRADE_PERMISSION_SKILL, uiscriptlocale.GUILD_MEMBER_WAR, uiscriptlocale.GUILD_MEMBER_NAME, uiscriptlocale.GUILD_MEMBER_RANK, uiscriptlocale.GUILD_MEMBER_JOB, uiscriptlocale.GUILD_MEMBER_LEVEL, uiscriptlocale.GUILD_MEMBER_SPECIFIC_GRAVITY, uiscriptlocale.GUILD_MEMBER_KNIGHT]
		#try:
		self.toolTip.ClearToolTip()
		text = text[arg]
		width = 6 * len(text) + 22
		self.toolTip.SetThinBoardSize(width)
	...
	def OverOutToolTip(self, arg2, arg) :
		self.toolTip.Hide()
		self.ShowToolTip = False
	...
	def __MakeInfoPage(self):
		...
		try:
			...
			if app.ADVANCED_GUILD_INFO:
				page.trophiesSlot = page.GetChild("GuildTrophiesValue")
				page.winsSlot = page.GetChild("GuildWinsValue")
				page.lossSlot = page.GetChild("GuildLossValue")
				page.drawsSlot = page.GetChild("GuildDrawValue")
				page.onebonusSlot = page.GetChild("GuildBonus1")
				page.twobonusSlot = page.GetChild("GuildBonus2")
				page.threebonusSlot = page.GetChild("GuildBonus3")
			...
			if not app.ADVANCED_GUILD_INFO:
				...
				page.GetChild("EnemyGuildSlot3").Hide()
				page.GetChild("EnemyGuildSlot4").Hide()
				page.GetChild("EnemyGuildSlot5").Hide()
				page.GetChild("EnemyGuildSlot6").Hide()
	...
	def __MakeBoardPage(self):
		...
		for i in xrange(12):
			...
			## Delete Button
			deleteButton = ui.MakeButton(page, 420, yPos + 3, localeinfo.GUILD_DELETE, "d:/ymir work/ui/public/", "close_button_01.sub", "close_button_02.sub", "close_button_03.sub")
			...
			commentSlot.SetPosition(113, yPos)
			commentSlot.Show()
		...
		postCommentButton = ui.MakeButton(page, 415, 273, localeinfo.GUILD_COMMENT, "d:/ymir work/ui/game/taskbar/", "Send_Chat_Button_01.sub", "Send_Chat_Button_02.sub", "Send_Chat_Button_03.sub")
	...
	def __MakeMemberPage(self):
		...
		for i in xrange(self.MEMBER_LINE_COUNT):
			...
			gradeSlot.SetPosition(100, yPos) #101
			gradeSlot.SetSize(98, 17)
			...
			## Job
			jobSlotImage = ui.MakeImageBox(page, "d:/ymir work/ui/public/Parameter_Slot_03.sub", 199, yPos)#170
			jobSlot = ui.MakeTextLine(jobSlotImage)
			page.Children.append(jobSlotImage)
			page.Children.append(jobSlot)

			## Level
			levelSlotImage = ui.MakeImageBox(page, "d:/ymir work/ui/public/Parameter_Slot_00.sub", 289, yPos)#210
			levelSlot = ui.MakeTextLine(levelSlotImage)
			page.Children.append(levelSlotImage)
			page.Children.append(levelSlot)

			## Offer
			offerSlotImage = ui.MakeImageBox(page, "d:/ymir work/ui/public/Parameter_Slot_00.sub", 328, yPos)#250
			...
			generalEnableCheckBox = CheckBox(page, 375, yPos, event, "d:/ymir work/ui/public/Parameter_Slot_00.sub")#297
	...
	def __MakeGradePage(self):
		...
		for i in xrange(15):
			...
			yPos = 22 + i*lineStep
			index = i+1
			gradeNumberSlotImage = ui.MakeImageBox(page, "d:/ymir work/ui/public/Parameter_Slot_00.sub", 4, yPos)
			...
			## GradeName
			gradeNameSlot = EditableTextSlot(page, 43, yPos)
			...
			inviteAuthorityCheckBox = CheckBox(page, 133, yPos, event)
			...
			driveoutAuthorityCheckBox = CheckBox(page, 185, yPos, event)
			...
			noticeAuthorityCheckBox = CheckBox(page, 237, yPos, event)
			...
			skillAuthorityCheckBox = CheckBox(page, 289, yPos, event)
	...
	def RefreshGuildInfoPage(self):
		...
		if app.ADVANCED_GUILD_INFO:
			page.trophiesSlot.SetText(str(guild.GetGuildTrophies()))
			one, two, three = guild.GetGuildStats()
			page.winsSlot.SetText(str(one))
			page.lossSlot.SetText(str(two))
			page.drawsSlot.SetText(str(three))
			page.onebonusSlot.SetText(str(one) + "/5  Premio 1 Gaya")
			page.twobonusSlot.SetText(str(one) + "/10  Premio 3 Gaya")
			page.threebonusSlot.SetText(str(one) + "/15  Premio 15 Gaya")
