...
class SlotWindow(Window):
	...
	if app.ENABLE_HIGHLIGHT_SYSTEM:
		def IsActiveSlot(self, slotNumber):
			return wndMgr.IsActiveSlot(self.hWnd, slotNumber)
...
class PythonScriptLoader(object):
	...
	def LoadScriptFile(self, window, FileName):
		...
		if __USE_DYNAMIC_MODULE__:
			sandbox = Sandbox(True, ["uiscriptlocale", "localeinfo", "sys", "item"])
		else:
		...
		if __USE_DYNAMIC_MODULE__:
			...
			self.ScriptDictionary["ENABLE_CONQUEROR_LEVEL"] = app.ENABLE_CONQUEROR_LEVEL
			self.ScriptDictionary["ENABLE_WEAPON_COSTUME_SYSTEM"] = app.ENABLE_WEAPON_COSTUME_SYSTEM
			self.ScriptDictionary["ENABLE_MOUNT_COSTUME_SYSTEM"] = app.ENABLE_MOUNT_COSTUME_SYSTEM
			...
			self.ScriptDictionary["ENABLE_WOLFMAN_CHARACTER"] = app.ENABLE_WOLFMAN_CHARACTER
			...
			self.ScriptDictionary["RUNE_SLOT_START"] = player.RUNE_SLOT_START
