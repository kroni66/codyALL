...
class CreateCharacterWindow(ui.Window):
	...
	if app.ENABLE_WOLFMAN_CHARACTER:
		M2STATPOINT += (( 6, 2, 2, 6 ),)
		M2JOBLIST.update({4	:	localeinfo.JOB_WOLFMAN,})
	...
	if app.ENABLE_WOLFMAN_CHARACTER:
		...
		RACE_FACE_PATH.update({playersettingmodule.RACE_WOLFMAN_M		:	"D:/ymir work/ui/intro/public_intro/face/face_wolfman_m_0",})
		RACE_FACE_PATH.update({playersettingmodule.RACE_WOLFMAN_M		:"d:/ymir work/bin/icon/face/wolfman_m.tga",})
		DESCRIPTION_FILE_NAME_LIMIT.update({playersettingmodule.RACE_WOLFMAN_M : 1,})
	...
	def Open(self):
		...
		if app.ENABLE_WOLFMAN_CHARACTER:
			pythonScriptLoader.LoadScriptFile( self.dlgBoard, uiscriptlocale.LOCALE_UISCRIPT_PATH + "createcharacterwindow2.py")
		else:
