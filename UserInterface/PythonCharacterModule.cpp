...
PyObject * chrIsPC(PyObject* poSelf, PyObject* poArgs)
{
	int iVirtualID;
	if (!PyTuple_GetInteger(poArgs, 0, &iVirtualID))
		return Py_BuildException();
	...
	return Py_BuildValue("i", pInstance->IsPC());
}
...
void initchr()
{
...
#if defined(PYTHON_DYNAMIC_MODULE_NAME)
	PyObject* poModule = Py_InitModule(GetModuleName(CHR_MODULE).c_str(), s_methods);
#else
	...
	PyModule_AddIntConstant(poModule, "MOTION_SELFIE",				CRaceMotionData::NAME_SELFIE);
	PyModule_AddIntConstant(poModule, "MOTION_DANCE_7",				CRaceMotionData::NAME_DANCE_7);
	PyModule_AddIntConstant(poModule, "MOTION_DOZE",				CRaceMotionData::NAME_DOZE);
	PyModule_AddIntConstant(poModule, "MOTION_EXERCISE",				CRaceMotionData::NAME_EXERCISE);
	PyModule_AddIntConstant(poModule, "MOTION_PUSHUP",				CRaceMotionData::NAME_PUSHUP);
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_BATTLE_PASS",		CInstanceBase::NEW_AFFECT_BATTLE_PASS);
#endif
	...
	PyModule_AddIntConstant(poModule, "AFFECT_DROP_BLOCK", CInstanceBase::AFFECT_DROP_BLOCK);
	PyModule_AddIntConstant(poModule, "AFFECT_DROP_UNBLOCK", CInstanceBase::AFFECT_DROP_UNBLOCK);
#endif
#ifdef ENABLE_RUNE_SYSTEM
	PyModule_AddIntConstant(poModule, "AFFECT_RUNE1", CInstanceBase::AFFECT_RUNE1);
	PyModule_AddIntConstant(poModule, "AFFECT_RUNE2", CInstanceBase::AFFECT_RUNE2);
#endif
#ifdef ENABLE_NEW_USE_POTION
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_AUTO_HP_RECOVERY2", CInstanceBase::NEW_AFFECT_AUTO_HP_RECOVERY2);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_AUTO_SP_RECOVERY2", CInstanceBase::NEW_AFFECT_AUTO_SP_RECOVERY2);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION1", CInstanceBase::AFFECT_NEW_POTION1);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION2", CInstanceBase::AFFECT_NEW_POTION2);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION3", CInstanceBase::AFFECT_NEW_POTION3);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION4", CInstanceBase::AFFECT_NEW_POTION4);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION5", CInstanceBase::AFFECT_NEW_POTION5);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION6", CInstanceBase::AFFECT_NEW_POTION6);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION7", CInstanceBase::AFFECT_NEW_POTION7);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION8", CInstanceBase::AFFECT_NEW_POTION8);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION9", CInstanceBase::AFFECT_NEW_POTION9);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION10", CInstanceBase::AFFECT_NEW_POTION10);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION11", CInstanceBase::AFFECT_NEW_POTION11);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION12", CInstanceBase::AFFECT_NEW_POTION12);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION13", CInstanceBase::AFFECT_NEW_POTION13);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION14", CInstanceBase::AFFECT_NEW_POTION14);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION15", CInstanceBase::AFFECT_NEW_POTION15);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION16", CInstanceBase::AFFECT_NEW_POTION16);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION17", CInstanceBase::AFFECT_NEW_POTION17);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION18", CInstanceBase::AFFECT_NEW_POTION18);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION19", CInstanceBase::AFFECT_NEW_POTION19);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION20", CInstanceBase::AFFECT_NEW_POTION20);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION21", CInstanceBase::AFFECT_NEW_POTION21);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION22", CInstanceBase::AFFECT_NEW_POTION22);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION23", CInstanceBase::AFFECT_NEW_POTION23);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION24", CInstanceBase::AFFECT_NEW_POTION24);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION25", CInstanceBase::AFFECT_NEW_POTION25);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION26", CInstanceBase::AFFECT_NEW_POTION26);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION27", CInstanceBase::AFFECT_NEW_POTION27);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION28", CInstanceBase::AFFECT_NEW_POTION28);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION29", CInstanceBase::AFFECT_NEW_POTION29);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION30", CInstanceBase::AFFECT_NEW_POTION30);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION31", CInstanceBase::AFFECT_NEW_POTION31);
#endif
