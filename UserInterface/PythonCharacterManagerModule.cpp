...
PyObject * chrmgrSetRaceHeight(PyObject* poSelf, PyObject* poArgs)
{
	...
	float fRidingHeight = 0.0f;
	if (!PyTuple_GetFloat(poArgs, 2, &fRidingHeight))
		return Py_BadArgument();
	
	CRaceManager::Instance().SetRaceHeight(iRaceIndex, fRaceHeight, fRidingHeight);
	return Py_BuildNone();
}
#endif
...
void initchrmgr()
{
	...
	PyModule_AddIntConstant(poModule, "EFFECT_RUNE", CInstanceBase::EFFECT_RUNE);
#endif
	...
	PyModule_AddIntConstant(poModule, "EFFECT_TALISMAN_EQUIP_FIRE", CInstanceBase::EFFECT_TALISMAN_EQUIP_FIRE);
	PyModule_AddIntConstant(poModule, "EFFECT_TALISMAN_EQUIP_ICE", CInstanceBase::EFFECT_TALISMAN_EQUIP_ICE);
	PyModule_AddIntConstant(poModule, "EFFECT_TALISMAN_EQUIP_WIND", CInstanceBase::EFFECT_TALISMAN_EQUIP_WIND);
	PyModule_AddIntConstant(poModule, "EFFECT_TALISMAN_EQUIP_EARTH", CInstanceBase::EFFECT_TALISMAN_EQUIP_EARTH);
	PyModule_AddIntConstant(poModule, "EFFECT_TALISMAN_EQUIP_DARK", CInstanceBase::EFFECT_TALISMAN_EQUIP_DARK);
	PyModule_AddIntConstant(poModule, "EFFECT_TALISMAN_EQUIP_ELEC", CInstanceBase::EFFECT_TALISMAN_EQUIP_ELEC);
#endif
}
