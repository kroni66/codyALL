...
const DWORD c_Extra_Inventory_Refine = c_Extra_Inventory_Count * c_Extra_Inventory_Category_Count;
#endif
...
const DWORD c_Wear_Rune_Start = c_Equipment_Start + 32;
const DWORD c_Wear_Rune_Count = 7;
const DWORD c_Wear_Max = 39;
#else
...
const DWORD c_DragonSoul_Inventory_Count = 300 + (CItemData::DS_SLOT_NUM_TYPES * DRAGON_SOUL_GRADE_MAX * c_DragonSoul_Inventory_Box_Size);
