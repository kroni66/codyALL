...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		CMainPacketHeaderMap()
		{
			...
			Set(HEADER_GC_RECV_LANGUAGE, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketRecvLang), STATIC_SIZE_PACKET));
#endif
#ifdef TEXTS_IMPROVEMENT
			Set(HEADER_GC_CHAT_NEW, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCChatNew), STATIC_SIZE_PACKET));
#endif
