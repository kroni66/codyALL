...
class CWhisper
{
	public:
		...
		typedef std::deque<TChatLine*> TChatLineDeque2;
#endif
...
#ifdef ENABLE_AUTO_TRANSLATE_WHISPER
		, bool bTranslated, int codepage = 0
#endif
		);
...
#ifdef ENABLE_AUTO_TRANSLATE_WHISPER
		TChatLineDeque2 m_ChatLineDeque2;
#endif
...
#ifdef ENABLE_AUTO_TRANSLATE_WHISPER
		, bool translated = false, bool bnew = false, int unicode = 0
#endif
		);
