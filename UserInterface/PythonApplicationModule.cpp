...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ENABLE_PLAYER_PIN_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PLAYER_PIN_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ADVANCED_GUILD_INFO", 1);
#else
	PyModule_AddIntConstant(poModule, "ADVANCED_GUILD_INFO", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SAVEPOINT_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SAVEPOINT_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_CIANITE__", 1);
#else
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_CIANITE__", 0);
#endif

#ifdef __ENABLE_NEW_EFFECT_CIANITE_WEAPON__
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_CIANITE_WEAPON__", 1);
#else
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_CIANITE_WEAPON__", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "__ENABLE_EXTEND_INVEN_SYSTEM__",	1);
#else
	PyModule_AddIntConstant(poModule, "__ENABLE_EXTEND_INVEN_SYSTEM__",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_PASSIVE_SKILLS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_PASSIVE_SKILLS", 0);
#endif
#ifdef ENABLE_NEW_SECONDARY_SKILLS
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_SECONDARY_SKILLS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_SECONDARY_SKILLS", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_LOCKED_EXTRA_INVENTORY", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_LOCKED_EXTRA_INVENTORY", 0);
#endif
#ifdef ENABLE_DS_SET
	...
	PyModule_AddIntConstant(poModule, "KASMIR_PAKET_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "KASMIR_PAKET_SYSTEM", 0);
#endif
#ifdef __ENABLE_NEW_EFFECT_ZODIACO__
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_ZODIACO__", 1);
#else
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_ZODIACO__", 0);
#endif
#ifdef __ENABLE_NEW_EFFECT_ZODIACO_WEAPON__
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_ZODIACO_WEAPON__", 1);
#else
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_ZODIACO_WEAPON__", 0);
#endif
#ifdef __ENABLE_NEW_EFFECT_ZODIACO1__
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_ZODIACO1__", 1);
#else
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_ZODIACO1__", 0);
#endif
#ifdef __ENABLE_NEW_EFFECT_ZODIACO_WEAPON1__
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_ZODIACO_WEAPON1__", 1);
#else
	PyModule_AddIntConstant(poModule, "__ENABLE_NEW_EFFECT_ZODIACO_WEAPON1__", 0);
#endif
#ifdef ENABLE_MULTI_LANGUAGE
	...
	PyModule_AddIntConstant(poModule, "ENABLE_DS_RUNE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DS_RUNE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_AUTO_TRANSLATE_WHISPER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_AUTO_TRANSLATE_WHISPER", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_BUGFIXES", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_BUGFIXES", 0);
#endif
#ifdef INGAME_WIKI
	...
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_GYEONGGONG_SKILL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_GYEONGGONG_SKILL", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_TALISMAN_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TALISMAN_EFFECT", 0);
#endif
PyModule_AddIntConstant(poModule, "ENABLE_CLIENT_OPTIMIZATION", 0);
#ifdef ENABLE_DOGMODE
	PyModule_AddIntConstant(poModule, "ENABLE_DOGMODE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DOGMODE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_CHRISTMAS_2021", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHRISTMAS_2021", 0);
#endif
#ifdef ENABLE_CHRISTMAS_WHEEL_OF_DESTINY
	PyModule_AddIntConstant(poModule, "ENABLE_CHRISTMAS_WHEEL_OF_DESTINY", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHRISTMAS_WHEEL_OF_DESTINY", 0);
#endif
#if defined(ENABLE_BUGFIXES)
	PyModule_AddIntConstant(poModule, "ENABLE_BUGFIXES", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BUGFIXES", 0);
#endif
