...
class CActorInstance : public IActorInstance, public IFlyTargetableObject
{
...
#ifdef ENABLE_SKILL_COLOR_SYSTEM
		DWORD AttachEffectByID(DWORD dwParentPartIndex, const char * c_pszBoneName, DWORD dwEffectID, const D3DXVECTOR3 * c_pv3Position = NULL, DWORD * dwSkillColor = NULL);
#else
	...
	public:
		...
		bool RaceMustHaveCollision(DWORD race);
#endif
